...
export default function AetierCaseStudy() {
  ...
  const project = {
    name: 'AETIER',
    subtitle: 'A bespoke brand platform for modern elegance.',
    objective: 'Aetier needed a digital platform that would establish their brand identity and showcase their luxury goods. The challenge was to create a sophisticated, elegant website that would appeal to a high-end audience and showcase their aesthetic vision.',
    capabilities: [
      'Brand Strategy',
      'Digital Experience',
      'UI/UX Design'
    ],
    heroImage: '/assets/images/projects/aetier/featured.png',
    showcaseImages: [
      '/assets/images/projects/aetier/homepage-screenshot.png'
    ],
    testimonial: 'CTRL+BUILD delivered a platform that perfectly captures our brand identity and aesthetic vision.',
    nextProject: 'IPOWER',
    website: 'https://aetier.pages.dev'
  };
